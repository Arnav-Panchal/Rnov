  ...
  return (
    <div>
      <main className={oswald.className}>
        ...
        <h2 className={`${oswald.className} ml-10 mt-6 text-2xl sm:text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl hover:scale-105 transition-transform duration-300`}>
              Arnav Panchal
            </h2>
          <div className="text-center flex p-10 py-10" style={customFontStyle}>
